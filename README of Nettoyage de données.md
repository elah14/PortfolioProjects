...
Parsing de Chaînes : Extraction de composants (Adresse, Ville, État) à l'aide de SUBSTRING, CHARINDEX et de la méthode astucieuse PARSENAME. 
...
Modification de Schéma : Nettoyage final de la table avec DROP COLUMN pour supprimer les colonnes obsolètes après transformation. 
